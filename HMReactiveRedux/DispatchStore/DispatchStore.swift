...
public final class DispatchStore<Value> {
	...
	public static func createInstance(_ initialState: TreeState<Value>,
																		_ reducer: @escaping ReduxReducer<TreeState<Value>>)
		-> DispatchStore<Value>
	{
	...
	fileprivate let reducer: ReduxReducer<TreeState<Value>>
	fileprivate var callbacks: [String : [String : ReduxCallback<Value>]]
	fileprivate var state: TreeState<Value>

	var currentState: TreeState<Value> {
		return state
	}

	fileprivate init(_ initialState: TreeState<Value>,
									 _ reducer: @escaping ReduxReducer<TreeState<Value>>) {
